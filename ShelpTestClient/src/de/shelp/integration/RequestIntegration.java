...
public interface RequestIntegration {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "getRequest", targetNamespace = "http://integration.shelp.de/", className = "de.shelp.integration.GetRequest")
    @WebMethod
    @ResponseWrapper(localName = "getRequestResponse", targetNamespace = "http://integration.shelp.de/", className = "de.shelp.integration.GetRequestResponse")
    public de.shelp.integration.RequestResponse getRequest(
        @WebParam(name = "arg0", targetNamespace = "")
        long arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        int arg1
